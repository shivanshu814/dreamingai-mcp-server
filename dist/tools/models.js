...
export function registerModelTools(server) {
    // ── List Models ─────────────────────────────────────────────────────
    server.tool("list_models", "List all available AI models and platforms in DreamingAI", {
        platform: z
            .string()
            .optional()
    ...
    // ── Get Model ───────────────────────────────────────────────────────
    server.tool("get_model", "Get details and capabilities of a specific AI model in DreamingAI", {
    ...
    // ── Switch Model ────────────────────────────────────────────────────
    server.tool("switch_model", "Switch the active AI model for conversations in DreamingAI", {
        modelId: z.string().describe("ID of the model to switch to"),
        conversationId: z
            .string()
            .optional()
            .describe("Conversation ID to switch model for (if not set, changes default)"),
